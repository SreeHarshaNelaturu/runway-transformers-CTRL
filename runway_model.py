...
command_inputs = {
    ...
    "temperature" : number(default=0.7, step=1, description="Temperature of output distribution"),
    "repetition_penalty" : number(default=1.2, step=0.1,description="Repetition penalty for the model"),
